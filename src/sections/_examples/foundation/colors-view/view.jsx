...
const COLOR_PALETTE = ['primary', 'secondary', 'info', 'success', 'warning', 'error'];

const COLOR_VARIATIONS = ['lighter', 'light', 'main', 'dark', 'darker'];
...
function ColorCard({ varColor, hexColor, variation, sx, ...other }) {
  return (
    <Box
      sx={[
        (theme) => ({
