...
const StyledWithState = styled(
  (props) => <div {...props} className={mergeClasses(['root', props.className])} />,
  {
    shouldForwardProp: (prop) => !['open', 'active', 'focused', 'disabled', 'sx'].includes(prop),
  }
)(({ theme }) => ({
  ...baseStyles,
...
const StyledHtmlNoRef = styled(
  (props) => <ul {...props} className={mergeClasses(['root', props.className])} />,
...
const StyledBoxNoRef = styled(
  (props) => <Box {...props} component="ul" className={mergeClasses(['root', props.className])} />,
  { shouldForwardProp: (prop) => !['active', 'sx'].includes(prop) }
)(({ theme }) => ({
  ...baseStyles,
  backgroundColor: theme.vars.palette.background.neutral,
